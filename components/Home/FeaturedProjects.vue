    ...
    <div class="max-w-site mx-auto px-6 sm:px-8 lg:px-16 py-20 sm:py-24 lg:py-28">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 mb-14 sm:mb-16">
        <div class="lg:col-span-7 text-right">
          ...
          >
            ...
            <span class="relative inline-block">
              <span class="relative">مختارة</span>
              <span
        ...
        <div class="lg:col-span-5 flex items-end justify-start lg:justify-end">
          ...
          >
            <span
              class="inline-flex items-center gap-1.5 bg-cream-deep rounded-full px-3.5 py-1.5 text-ink"
            >
      ...
      <div class="mt-12 text-center">
        <NuxtLink
          to="/projects"
          class="inline-flex items-center gap-2 bg-cream-deep hover:bg-[#EDEDF0] text-ink rounded-full px-6 py-3 text-[13px] font-semibold transition-colors"
        >
          كل المشاريع
