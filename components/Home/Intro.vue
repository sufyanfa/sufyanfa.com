<template>
  <div class="space-y-6">
    ...
    <p class="text-gray-900 dark:text-gray-400 text-lg">
     مهندس برمجيات ومصمم تجارب، شغوف بتحويل التحديات إلى منتجات رقمية. أُتقن بناء الأنظمة، تصميم البساطة، وخلق تجارب تُصمَّم لتبقى.
    </p>
    <p class="text-gray-900 dark:text-gray-400">
      أساعد الأفراد والشركات  في بناء منتجات رقمية تحقق أهدافهم، من خلال الجمع بين الخبرة التقنية والفهم لاحتياجات المستخدمين.
    </p>
  </div>
</template>
